# Windows 11 25H2 Debloater — Version-Aware Tool

**A 25H2-aware debloat utility that knows what this specific build ships and what's safe to remove.**
...
Generic debloaters age badly; version-specific ones are nearly absent on GitHub.

## Checklist before you start

- [ ] You read this README (you're doing it)
- [ ] You know where your backups live
- [ ] You understand the single-player / personal-use scope
- [ ] You're getting the file from the Download button above — nowhere else

## What this project is about

☑️ **Goal** — 25H2 package map documented in-repo
☑️ **Scope** — Preset tiers (safe / deep / expert)
☑️ **Approach** — Dry-run preview of every change
☑️ **Principle** — Revert script generation
☑️ **Detail** — Community-maintained package lists
